...
void GVRET_Comm_Handler::processIncomingByte(uint8_t in_byte)
{
    ...
    case GET_COMMAND:
        ...
        case ADDID:
            // Comando para adicionar ID
            //Serial.println("Comando ADDID recebido");
            state = ADDID;
            step = 0;
            break;
        case REMOVEID:
            // Comando para remover ID
            //Serial.println("Comando REMOVEID recebido");
            state = REMOVEID;
            step = 0;
            break;
        case FILTER:
